        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm mt-1">
                        Quản lý tin nhắn từ Facebook và Instagram
                    </p>
                </div>
            ...
            <div className="flex gap-2 border-b border-gray-200 dark:border-gray-700">
                <button
                    ...
                    className={`px-6 py-3 font-medium transition-all flex items-center gap-2 ${activeTab === 'facebook'
                ...
                <button
                    ...
                    className={`px-6 py-3 font-medium transition-all flex items-center gap-2 ${activeTab === 'instagram'
